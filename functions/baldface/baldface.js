...
const handler = async function (event) {
  try {
    const response = await fetch('https://live.rawmotion.com/api/v1/event/7165c981-925e-11ec-b53d-e979d4411faa/contests')
    ...
    const file = myBucket.file('baldface-results.json');
